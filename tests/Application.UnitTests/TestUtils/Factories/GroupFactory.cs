...
public static class GroupFactory
{
    public static List<Group> CreateGroupList(List<Student>? students = null,
        ...
        => Enumerable.Range(0, groupsCount).Select(index =>
                CreateGroupWithSubjects(students: students))
            .ToList();

    public static Group CreateGroupWithSubjects(Guid? groupId = null,
    ...
    public static Group CreateGroupWithOutSubjects(Guid? groupId = null,
        string? groupName = null,
        int? course = null,
        string? department = null,
        List<Student>? students = null,
